...
# Ejecuta el script de Python que deseas programar
    subprocess.run(["python", "C:\Users\Lenovo\OneDrive\Documentos\GitHub\DashFCI\df_api.py"])
    
    # Realiza un git push para actualizar la app web
    subprocess.run(["git", "add", "."])
    subprocess.run(["git", "commit", "-m", "Actualización diaria"])
    subprocess.run(["git", "push"])

# Programa la tarea para que se ejecute todos los días a las 23:59
